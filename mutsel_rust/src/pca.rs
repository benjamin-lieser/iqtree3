...
pub fn read_pca_components() -> (Tensor, Tensor) {
    let components: Vec<f64> = super::data::PCA
        .split_whitespace()
...
pub fn penalty_on_pca_coordinates(singular_values: &Tensor, pca_coordinates: &Tensor) -> Tensor {
